       ...
       <div class="text-center">
        ...
        <ul class="row justify-content-center">
            <li class="p-4">
                ...
                <svg height="25" style="border-radius: 4px; background-color: aliceblue;"  width="15" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"  viewBox="5 0 25 35" style="enable-background:new 0 0 35 35;" xml:space="preserve">
                    <g>
                    ...
                    <div class="col-md-6">
                        <form action="send_email.php" method="POST" id="contactForm" enctype="multipart/form-data">
                            <div class="mail_section_1">
                                ...
                                <div class="mb-3">
                                    <label for="formFile" class="form-label">Foto erbij (optioneel)</label><br>
